      ...
      <article className="text-center space-y-4 sm:space-y-6 w-full max-w-md mx-auto p-4 sm:p-6 glass-card glass-card-dark fade-in">
        <header className="flex justify-center">
          <div className="p-3 sm:p-4 rounded-full bg-destructive/10">
            <ServerCrash className="h-8 w-8 sm:h-12 sm:w-12 text-destructive" aria-hidden="true" />
          </div>
        </header>
        <section>
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground">500</h1>
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Server Error</h2>
